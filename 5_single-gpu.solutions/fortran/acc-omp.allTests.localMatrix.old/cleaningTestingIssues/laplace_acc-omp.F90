...
#      endif
       ...
       real elapsed_time
#      ifndef _ALL_INTERNAL_
#         if defined(_JUSTACC_) || defined(_ACCTIP_)
             call allocateArrays_acc
#         endif
#         if defined(_JUSTOMP_) || defined(_OMPTIP_)
             call allocateArrays_omp
#         endif
#      else
...
#      ifndef _NOPRELOAD_
#         if defined(_JUSTACC_) || defined(_PRELOADACC_) || defined(_ACCTIP_)
!--!$acc        data copy(T) create(T_new)
!$acc        data copy(T(:GRIDX+2,:GRIDY+2)) create(T_new(:GRIDX+2,:GRIDY+2))
#         endif
#         if defined(_JUSTOMP_) || defined(_PRELOADOMP_) || defined(_OMPTIP_)
...
#      ifndef _ALL_INTERNAL_
#         if defined(_JUSTACC_) || defined(_ACCTIP_)
             call deallocateArrays_acc
#         endif
#         if defined(_JUSTOMP_) || defined(_OMPTIP_)
             call deallocateArrays_omp
#         endif
#      else
          deallocate(T)
          deallocate(T_new)
#      endif
       ...
       use globals
       implicit none
!AEG:Dropped when turning into global arrays:double precision, intent( out ) :: T(GRIDX+2,GRIDY+2)
       integer i,j
